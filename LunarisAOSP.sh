...
git clone --depth 1 --branch LunarisAosp https://github.com/andrey167/android_device_xiaomi_platina_android16.git device/xiaomi/platina
...
rm -rf vendor/evolution-priv/keys vendor/lineage-priv/keys vendor/lunaris-priv/keys
